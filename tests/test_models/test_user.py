...
class TestUser_instantiation(unittest.TestCase):
    """
    testing user instantiation of the User class.
    """
...
class TestUser_save(unittest.TestCase):
    """user testing save method of the  class."""
...
class TestUser_to_dict(unittest.TestCase):
    """testing user to_dict method of the User class."""
