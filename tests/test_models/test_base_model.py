...
class TestBaseModel(unittest.TestCase):
    """writes a tests for Amenity Class"""

    @classmethod
    def setUp(cls):
        """defines a each test case.
        """
    ...
    def testBaseModel1(self):
        """define value of a BaseModel instance.
        """
    ...
    def test_types(self):
        """define attributes type is correct.
        """
    ...
    def test_save(self):
        """define save if save method is working correctly after update.
        """
        self.BaseModel1.save()
    ...
    def test_functions(self):
        """define test BaseModel moudule is documented.
        """
        self.assertIsNotNone(BaseModel.__doc__)

    def test_has_attributes(self):
        """ define test att if expected attributes exist.
        """
    ...
    def test_unique_id(self):
        """Test if each unique is created with a unique ID.
        """
