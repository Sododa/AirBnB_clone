#!/usr/bin/python3
"""
Model used for Place class unittest
"""
import os
import models
import unittest
...
class TestPlace_instantiation(unittest.TestCase):
    """
    test place instantiation of the Place class.
    """
...
class TestPlace_save(unittest.TestCase):
    """
    test place save save method of the Place class.
    """
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        my_place = Place()
        my_place.middle_name = "Sohnson"
        my_place.my_number = 777
        self.assertEqual("Sohnson", my_place.middle_name)
