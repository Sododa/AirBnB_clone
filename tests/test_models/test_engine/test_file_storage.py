"""
import unitest Module for FileStorage
"""
import unittest
...
class TestFileStorage(unittest.TestCase):
    ''' testfile storage unittest for FileStorage class '''

    def test_Instantiation(self):
        ''' checks instantiotion BaseModel '''
        obj = FileStorage()
    ...
    def test_new(self):
        """
        self: new (saves new object into dictionary)
        """
    ...
    def test_reload(self):
        """
        Tests self: reload (reloads objects from string file)
        """
    ...
    def test_funcdocs(self):
        ''' define functions docstring '''
        for func in dir(FileStorage):
            self.assertTrue(len(func.__doc__) > 0)

    def test_save(self):
        ''' tests self save method'''
        obj = FileStorage()
        new_obj = BaseModel()
        obj.new(new_obj)
        dict1 = obj.all()
