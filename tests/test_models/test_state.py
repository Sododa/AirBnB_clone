...
class TestState_instantiation(unittest.TestCase):
    """
    testing state instantiation of the State class.
    """
...
class TestState_save(unittest.TestCase):
    """
    TEST stt save method of the State class.
    """
...
class TestState_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        state = State()
        state.middle_name = "Sohnson"
        state.my_number = 777
        self.assertEqual("Sohnson", state.middle_name)
