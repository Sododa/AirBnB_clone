...
class TestReview_instantiation(unittest.TestCase):
    """
    class test review instantiation of the Review class.
    """
...
class TestReview_save(unittest.TestCase):
    """
    test review testing save method of the Review class.
    """
...
class TestReview_to_dict(unittest.TestCase):
    """
    test review to_dict method of the Review class.
    """
    ...
    def test_to_dict_contains_added_attributes(self):
        review = Review()
        review.middle_name = "Sohnson"
        review.my_number = 777
        self.assertEqual("Sohnson", review.middle_name)
